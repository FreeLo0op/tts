...
def _expand_number(m):
    ...
    '''
    return _inflect.number_to_words(num, andword='and')
...
def en_normalize(sentence):
    ...
    sentence = re.sub(r'(mr|Mr|Ms|ms|dr|Dr)\.', r'\1 ', sentence)
    #sentence = re.sub(r'(?<=\w)--+(?=\w)', ' ', sentence)
    # sentence = re.findall(r'[a-z]+[\'\-]?[a-z]+|[a-z]|[\,\.\!\?]', sentence)
    sentence = re.findall(r'[a-zA-Z]+|[a-zA-Z]|[\,\.\!\?]', sentence)
    #sentence = re.findall(r'[a-z\'\-\.]+', sentence)

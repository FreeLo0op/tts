...
class Time(Processor):
    ...
    def build_tagger(self):
        h = string_file('tal_frontend/frontend/normalizer/cn/data/time/hour.tsv')
        m = string_file('tal_frontend/frontend/normalizer/cn/data/time/minute.tsv')
        s = string_file('tal_frontend/frontend/normalizer/cn/data/time/second.tsv')
        noon = string_file('tal_frontend/frontend/normalizer/cn/data/time/noon.tsv')
        colon = delete(':') | delete('：')

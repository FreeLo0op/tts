...
class Sport(Processor):
    ...
    def build_tagger(self):
        country = string_file('tal_frontend/frontend/normalizer/cn/data/sport/country.tsv')
        club = string_file('tal_frontend/frontend/normalizer/cn/data/sport/club.tsv')

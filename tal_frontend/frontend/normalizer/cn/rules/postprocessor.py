...
class PostProcessor(Processor):
    ...
    def __init__(self,
        ...
        blacklist = string_file('tal_frontend/frontend/normalizer/cn/data/default/blacklist.tsv')
        puncts = string_file('tal_frontend/frontend/normalizer/cn/data/char/punctuations_zh.tsv')
        full2half = string_file(
            'tal_frontend/frontend/normalizer/cn/data/char/fullwidth_to_halfwidth.tsv')
        zh_charset_std = string_file(
            'tal_frontend/frontend/normalizer/cn/data/char/charset_national_standard_2013_8105.tsv')
        zh_charset_ext = string_file(
            'tal_frontend/frontend/normalizer/cn/data/char/charset_extension.tsv')

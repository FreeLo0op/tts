...
#from paddlespeech.frontend.normalizer.rules.cardinal import Cardinal
...
class Whitelist(Processor):
    ...
    def build_tagger(self):
        whitelist = (string_file('tal_frontend/frontend/normalizer/cn/data/default/whitelist.tsv')
                     | string_file('tal_frontend/frontend/normalizer/cn/data/erhua/whitelist.tsv'))

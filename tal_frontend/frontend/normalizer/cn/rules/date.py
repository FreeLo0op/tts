...
class Date(Processor):
    ...
    def build_tagger(self):
        ...
        m = string_file('tal_frontend/frontend/normalizer/cn/data/date/m.tsv')
        mm = string_file('tal_frontend/frontend/normalizer/cn/data/date/mm.tsv')
        d = string_file('tal_frontend/frontend/normalizer/cn/data/date/d.tsv')
        dd = string_file('tal_frontend/frontend/normalizer/cn/data/date/dd.tsv')
        ...
        to = (delete('-') | delete('~') | delete('～')) + insert(' char { value: "到" } ')
